...
public class FarmworldInstances {
  ...
  public FarmworldInstances(Farmworld plugin, String name, String type, String schem) {
    ...
    String path = plugin.getServer().getPluginManager().getPlugin("WorldEdit").getDataFolder()
        .getAbsolutePath() + File.separator + "schematics" + File.separator + schem + ".schem";
    ...
    if (worldManager != null) {
      ...
      if (farmworldWorld == null) {
        worldManager.addWorld(name, // The worldname
